                        ...
                        <div class="panel-body">
                            <form method="POST" action="{{ route('admin.articles.save',$article->id) }}"
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="cover" id="CPIC" value="{{ old('cover', $article->cover) }}" readonly>
                                    <input type="hidden" class="form-control" name="thumb" id="CPCP" value="{{ old('thumb', $article->thumb) }}" readonly>
